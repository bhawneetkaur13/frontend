...
import ConditionallNode from './nodes/ConditionalNode'
...
export const PipelineUI = ({ onNodesEdgesUpdate }) => {
  ...
  const nodeTypes = useMemo(() => ({
    ...
    display: DisplayNode,
    summary: SummaryNode,
    conditional: ConditionallNode,
  }), []);

  useEffect(() => {
    onNodesEdgesUpdate(nodes, edges);
  }, [nodes, edges, onNodesEdgesUpdate]);
